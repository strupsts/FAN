...
VLM_VENV="${VLM_VENV:-${ML_RUNTIME_DIR}/venvs/fan-vllm-minicpmv45}"
VLM_MODEL="${VLM_MODEL:-openbmb/MiniCPM-V-4_5-AWQ}"
VLM_SERVED_MODEL_NAME="${VLM_SERVED_MODEL_NAME:-local-vlm-minicpm-receipt-parser}"
VLM_HOST="${VLM_HOST:-127.0.0.1}"
VLM_PORT="${VLM_PORT:-8003}"
...
echo "Starting MiniCPM-V 4.5 AWQ server..."
